            ...
            {architectureLayers.map((layer, index) => (
              ...
              >
                ...
                <div className="flex items-center mb-2">
                  <div className="w-8 h-8 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center text-white text-sm font-bold mr-4">
                    {index + 1}
                  </div>
                </div>
                
                {/* Layer card */}
                <div className="ml-4 md:ml-12 p-6 rounded-xl bg-zinc-900/50 border border-zinc-800">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card-hover p-8 rounded-xl bg-zinc-900/50 border border-zinc-800">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white">Platform Optimizer</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.metric} className="card-hover p-6 rounded-xl bg-black/50 border border-zinc-800 text-center">
                <div className="text-2xl font-bold text-white mb-2">{item.target}</div>
